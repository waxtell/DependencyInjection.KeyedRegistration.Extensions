...
namespace Microsoft.Extensions.DependencyInjection
{
    public static partial class ServiceCollectionExtensions
    {
        ...
        public static IServiceCollection AddNamedScoped<TKey, TService, TImplementation>(this IServiceCollection services, TKey key)
            where TService : class
            where TImplementation : class, TService
        {
            return 
                services
                    .AddNamedScoped(typeof(TService), typeof(TImplementation), key);
        }
